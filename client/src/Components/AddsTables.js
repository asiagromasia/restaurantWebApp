...
render(){
    ...
    <div>
        <div>
        <li>Table 1 
        Status:<input type="text" name="tableStatus" value={this.state.tableStatus} onChange={this.handleChange}/><a href='http://localhost:3000/api/reservation/table:1'><button type="reserve"> Reserve</button></a>
        <label>
